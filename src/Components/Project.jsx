...
const Project = (props) => {
    ...
    return (
        <>
            ...
            <div className="project-part2 p-3 md:p-6 lg:py-2 xl:py-10 h-[40%] sm:h-full w-full sm:w-[55%] bg-slate-800 rounded-b-lg sm:rounded-b-none sm:rounded-r-lg flex flex-col justify-start items-start gap-3 md:gap-4 text-white">
