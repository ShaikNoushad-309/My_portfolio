...
//         }
//
//         console.log("Entered a valid email");
//
...
//                 <form noValidate action="" className="h-auto w-full  min-h-fit flex flex-col justify-center items-center text-lg font-normal gap-3 " >
//                     <input type="text" name="name" id="name"  placeholder="Your name"  className="contact-input rounded-sm"/>
//                     <input type="email" name="email" id="email"  placeholder="Your email" className="contact-input rounded-sm"/>
//                     <input type="text" name="subject" id="subject"  placeholder="Subject" className="contact-input rounded-sm"/>
//                     <textarea name="message" placeholder="Message" id="msg"  className="contact-input rounded-sm h-auto min-h-[8em]"></textarea>
//                     {/*<button type="submit" className="contact-btn p-3 bg-cyan-600 w-[10%] rounded-md">Send</button>*/}
//                     <button onClick={handleSubmit} className="contact-btn cursor-pointer px-6 py-2 bg-[#615fff] text-black w-fit text-lg font-semibold rounded-md ">Send</button>
//                 </form>
//             </div>
//         </>
//     );
